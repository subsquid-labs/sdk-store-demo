...
# Minimal EVM squid with Different Data Storage Options
...
To extract EVM logs and transactions by a topic or a contract address, use [`.addLog()`](https://docs.sqd.dev/en/sdk), [`.addTransaction()`](https://docs.sqd.dev/en/sdk), [`.addTrace()`](https://docs.sqd.dev/en/sdk) or [`.addStateDiff()`](https://docs.sqd.dev/en/sdk) methods of the `EvmBatchProcessor` instance defined in `src/processor.ts`. Select data fields with [`.setFields()`](https://docs.sqd.dev/en/sdk).
